...
/**
 * Generate a signature for the separate Company Reports API.
 * @param key
 * @param applicationId
 * @param date
 * @returns {string}
 */
function genReportsSignature (key, applicationId, date) {
  const signString = [key, applicationId, date].join('|')
